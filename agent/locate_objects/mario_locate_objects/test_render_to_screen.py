...
for step in range(100):
    ...
    frames.append(obs)
    obs.savefig(f'videos/{step:003}', dpi = 100, facecolor = 'white')
...
with imageio.get_writer('videos/movie.gif', mode='I') as writer:
    for filename in range(100):
        image = imageio.imread(f'videos/{step:003}.png')
        writer.append_data(image)
        
imageio.mimwrite(os.path.join('./videos/', 'random_agent_1.gif'), frames, duration = 25)
