...
for step in range(100000):
    ...
    human_action = input("What action would you take? ")
    while not (human_action in ["0","1","2","3","4","5","6"]):
        human_action = input("Must be a number between 0-6 ")
    ...
    print(f"    You would choose {human_action}, the agent chose {action}")
